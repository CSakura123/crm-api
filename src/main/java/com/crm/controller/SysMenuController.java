...
public class SysMenuController {
    ...
    @Log(title = "菜单",businessType = BusinessType.OTHER)
    ...
    @Log(title = "按钮权限",businessType = BusinessType.GRANT)
    ...
    @Log(title = "信息",businessType = BusinessType.OTHER)
    ...
    @Log(title = "修改",businessType = BusinessType.INSERT_OR_UPDATE)
    ...
    @Log(title = "菜单列表",businessType = BusinessType.OTHER)
