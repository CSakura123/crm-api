...
public class SysRoleController {
    ...
    @Log(title = "分页信息",businessType = BusinessType.SELECT)
    ...
    @Log(title = "保存信息",businessType = BusinessType.INSERT_OR_UPDATE)
    ...
    @Log(title = "修改信息",businessType = BusinessType.INSERT_OR_UPDATE)
