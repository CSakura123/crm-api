...
public class SysManagerController {
    ...
    @Log(title = "管理员列表-分页参数",businessType = BusinessType.SELECT)
    ...
    @Log(title = "管理员列表-保存参数",businessType = BusinessType.INSERT_OR_UPDATE)
    ...
    @Log(title = "管理员列表-修改参数",businessType = BusinessType.INSERT_OR_UPDATE)
    ...
    @Log(title = "管理员列表-删除参数",businessType = BusinessType.DELETE)
    ...
    @Log(title = "管理员列表-获取管理员信息",businessType = BusinessType.SELECT)
    ...
    @Log(title = "管理员列表-修改密码参数",businessType = BusinessType.INSERT_OR_UPDATE)
