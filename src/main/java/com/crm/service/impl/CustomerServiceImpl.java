...
public class CustomerServiceImpl extends ServiceImpl<CustomerMapper, Customer> implements CustomerService {
    ...
    @Override
    public void saveOrUpdate(CustomerVO customerVO) throws java.rmi.ServerException {
        ...
        if (customerVO.getId() == null){
            ...
            if (customer != null){
                throw new java.rmi.ServerException("该手机号客户已存在，请勿重复添加");
            }
    ...
    @Override
    public void publicPoolToolToPrivate(IdQuery idQuery) throws ServerException {
        Customer customer = baseMapper.selectById(idQuery.getId());
        if (customer == null) {
            throw new ServerException("客户不存在,无法转入公海");
        }
